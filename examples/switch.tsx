      ...
      <div style={{ height: '150vh' }}>
        ...
        >
          ...
          <label>
            <input
              type="radio"
              name="switchHorizontalCount"
              value={0}
              checked={horizontalData.length === 0}
            />
            0
          </label>
          <label>
            <input
              ...
              name="switchHorizontalCount"
              value={2}
              checked={horizontalData.length === 2}
            />
            2
          </label>
          <label>
            <input
              ...
              name="switchHorizontalCount"
              value={20}
              checked={horizontalData.length === 20}
            />
            20
          </label>
          <label>
            <input
              ...
              name="switchHorizontalCount"
              value={100}
              checked={horizontalData.length === 100}
            />
            100
          </label>
          <label>
            <input
              ...
              name="switchHorizontalCount"
              value={200}
              checked={horizontalData.length === 200}
            />
            200
          </label>
          <label>
            <input
              ...
              name="switchHorizontalCount"
              value={1000}
              checked={horizontalData.length === 1000}
            />
            1000
          </label>
        </div>
