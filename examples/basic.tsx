  ...
  render() {
    ...
    return (
      <div
        ...
        className={`item ${isHorizontalMode ? 'item-horizontal' : ''}`}
      >
        {this.props.id}
      </div>
    );
...
const onScroll: (direction: IDirection) => UIEventHandler<HTMLElement> = (
  direction: IDirection,
) => (e) => {
  console.log(
    'scroll:',
    e.currentTarget[direction === IDirection.Horizontal ? 'scrollLeft' : 'scrollTop'],
  );
};
...
const Demo = () => {
  ...
  const [horizontalVisible, setHorizontalVisible] = useState(true);
        ...
        {!destroyHorizontal && (
          <List
            ...
            style={{
              ...
              boxSizing: 'border-box',
              width: 'min-content',
              display: horizontalVisible ? null : 'none',
            }}
